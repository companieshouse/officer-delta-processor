...
public class RetryableTopicErrorInterceptor implements ProducerInterceptor<String, Object> {
    ...
    private String getNextErrorTopic(ProducerRecord<String, Object> kafkaRecord) {
        ...
        return ((header1 != null && new String(header1.value()).contains(
                NonRetryableErrorException.class.getName())) || (header2 != null && new String(
                header2.value()).contains(NonRetryableErrorException.class.getName())))
