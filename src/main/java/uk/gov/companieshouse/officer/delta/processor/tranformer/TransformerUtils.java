...
public class TransformerUtils {
    ...
    private static final DateTimeFormatter MILLISECOND_DATETIME_FORMATTER = DateTimeFormatter.ofPattern(MILLISECONDS_DATETIME_PATTERN);
    ...
    public static OffsetDateTime parseOffsetDateTime(final String identifier, String rawDateTimeString)
        ...
        try {
            ...
            throw new NonRetryableErrorException(String.format("%s: date/time pattern not matched: [%s]",
                    identifier, MILLISECONDS_DATETIME_PATTERN), e);
        }
    }
    ...
    private static LocalDate convertToLocalDate(final String identifier, final String s, final String effectivePattern)
        ...
        try {
            ...
            throw new NonRetryableErrorException(String.format("%s: date/time pattern not matched: [%s]", identifier, effectivePattern), e);
        }
    }
