...
class PrincipalOfficeAddressTransformTest {

    private PrincipalOfficeAddressTransform principalOfficeAddressTransform;

    @BeforeEach
    void setUp() {
        principalOfficeAddressTransform = new PrincipalOfficeAddressTransform();
    }

    @Test
    void factory() {
        assertThat(principalOfficeAddressTransform.factory(), is(instanceOf(PrincipalOfficeAddress.class)));
    }
    ...
    void verifySuccessfulTransformOfAddress() {
        ...
        final PrincipalOfficeAddress result = principalOfficeAddressTransform.transform(addressAPI);
    ...
    void testTransformShouldHandleNullSource() {
        assertThat(principalOfficeAddressTransform.transform((AddressAPI) null), is(nullValue()));
    }
